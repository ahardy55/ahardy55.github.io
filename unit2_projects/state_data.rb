...
#Contains a high within a hash.  The first is a hash of states, and for each state that is a hash ontaining population, region and virus spread information. 
